...
function SelectLabel({
  ...
  return (
    <SelectPrimitive.Label
      ...
      className={cn("text-slate-500 px-2 py-1.5 text-xs dark:text-slate-400", className)}
      {...props} />
  );
}
